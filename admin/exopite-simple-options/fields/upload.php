		...
		public function output() {
            ...
            <script type="text/template" id="qq-template-manual-trigger">
                <div class="qq-uploader-selector qq-uploader"
                     qq-drop-area-text="<?php esc_html_e( 'Drop files here', 'swellenterprise' ); ?>">
                    ...
                    <div class="buttons">
                        <div class="qq-upload-button-selector exopite-sof-btn">
                            <div><?php esc_html_e( 'Select files', 'swellenterprise' ); ?></div>
                        </div>
                        <div class="exopite-sof-btn trigger-upload">
                            <i class="icon-upload icon-white"></i> <?php esc_html_e( 'Upload', 'swellenterprise' ); ?>
                        </div>
                    </div>
                    <span class="qq-drop-processing-selector qq-drop-processing">
                        <span><?php esc_html_e( 'Processing dropped files...', 'swellenterprise' ); ?></span>
                    ...
                    <ul class="qq-upload-list-selector qq-upload-list" aria-live="polite"
                        ...
                        <li>
                            ...
                            <button type="button"
                                    class="qq-btn qq-upload-cancel-selector qq-upload-cancel"><?php esc_html_e( 'Cancel', 'swellenterprise' ); ?></button>
                            <button type="button"
                                    class="qq-btn qq-upload-retry-selector qq-upload-retry"><?php esc_html_e( 'Retry', 'swellenterprise' ); ?></button>
                            <button type="button"
                                    class="qq-btn qq-upload-delete-selector qq-upload-delete"><?php esc_html_e( 'Delete', 'swellenterprise' ); ?></button>
                    ...
                    <dialog class="qq-alert-dialog-selector">
                        ...
                        <div class="qq-dialog-buttons">
                            <button type="button"
                                    class="qq-cancel-button-selector"><?php esc_html_e( 'Close', 'swellenterprise' ); ?></button>
                        </div>
                    </dialog>
                    ...
                    <dialog class="qq-confirm-dialog-selector">
                        ...
                        <div class="qq-dialog-buttons">
                            <button type="button"
                                    class="qq-cancel-button-selector"><?php esc_html_e( 'No', 'swellenterprise' ); ?></button>
                            <button type="button"
                                    class="qq-ok-button-selector"><?php esc_html_e( 'Yes', 'swellenterprise' ); ?></button>
                        </div>
                    </dialog>
                    ...
                    <dialog class="qq-prompt-dialog-selector">
                        ...
                        <div class="qq-dialog-buttons">
                            <button type="button"
                                    class="qq-cancel-button-selector"><?php esc_html_e( 'Cancel', 'swellenterprise' ); ?></button>
                            <button type="button"
                                    class="qq-ok-button-selector"><?php esc_html_e( 'Ok', 'swellenterprise' ); ?></button>
                        </div>
                    </dialog>
                </div>
            </script>
            ...
            <div class="qq-template-info">
				...
				echo esc_attr__( 'Max amount of files: ', 'swellenterprise' ) . $this->field['options']['filecount'] . '<br>';
				echo esc_attr__( 'Max file upload size: ', 'swellenterprise' ) . number_format( (float) ( Exopite_Simple_Options_Framework_Upload::file_upload_max_size() / 1048576 ), 2, '.', '' ) . 'Mb<br><br>';
				// echo '<i style="font-size:.9em;">' . esc_attr__( 'To increase file upload limit in the standard built-in WordPress media uploader up as large as available disk space allows, you could use', 'swellenterprise' ) . ' <a target="_blank" href="' . admin_url() . 'plugin-install.php?tab=plugin-information&plugin=tuxedo-big-file-uploads">Tuxedo Big File Uploads</a> ' . esc_attr__( 'Plugin', 'swellenterprise' ) . '</i>';
