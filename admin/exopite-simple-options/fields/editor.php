	...
	class Exopite_Simple_Options_Framework_Field_editor extends Exopite_Simple_Options_Framework_Fields {
		...
		public function output() {
			...
			if ( $editor == 'tinymce' && isset( $this->field['sub'] ) && $this->field['sub'] ) {
				...
				echo esc_html('<textarea id="' . esc_attr( $this->field['id'] ) . '" name="' . esc_attr( $this->element_name() ) . '" class="' . esc_attr( $classes ) . '"' . esc_attr( $this->element_attributes() ) . '>' . esc_attr( $this->element_value() ) . '</textarea>');
				...
				echo esc_html('<textarea id="' . esc_attr( $this->field['id'] ) . '" name="' . esc_attr( $this->element_name() ) . '" data-icon-path="' . plugin_dir_url( __DIR__ ) . 'assets/editors/trumbowyg/icons.svg" class="' . esc_attr( $classes ) . '"' . esc_attr( $this->element_attributes() ) . '>' . esc_attr( $this->element_value() ) . '</textarea>');
