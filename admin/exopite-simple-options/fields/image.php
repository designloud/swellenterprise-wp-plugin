...
if ( ! class_exists( 'Exopite_Simple_Options_Framework_Field_image' ) ) {
	...
	class Exopite_Simple_Options_Framework_Field_image extends Exopite_Simple_Options_Framework_Fields {
		...
		public function output() {
			...
			$add     = ( ! empty( $this->field['add_title'] ) ) ? $this->field['add_title'] : esc_attr__( 'Add Image', 'swellenterprise' );
			...
			echo esc_html('<div class="exopite-sof-media exopite-sof-image ' . esc_attr( $classes ) . '" ' . $this->element_attributes() . '>');
			echo esc_html('<div class="exopite-sof-image-preview' . esc_attr( $hidden ) . '">');
