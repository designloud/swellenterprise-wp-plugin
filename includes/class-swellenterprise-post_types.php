...
class SWELLEnterprise_Post_Types {
    ...
    public function create_custom_post_type() {
         ...
         */
        $my_options = get_exopite_sof_option('swellenterprise');
        ...
        $post_types_fields = array(
            ...
            array(
                ...
                'description' => 'Customize Your Client Portal',
                'has_archive' => false,
                'hierarchical' => false,
                'menu_icon' => 'dashicons-tag',
                'rewrite' => array(
        ...
        foreach ($post_types_fields as $fields) {
            if (isset($my_options[$fields['slug'] . '_switcher']) && $my_options[$fields['slug'] . '_switcher'] !== 'no') {
